{{/* title section */}}
{{if eq .event_type "create"}}Your AgenticHub issue has been created{{else if eq .event_type "comment"}}New comment on your AgenticHub issue #{{.issue_id}}{{else}}Your AgenticHub issue has been resolved{{if .resolved_issue_version}} in version {{.resolved_issue_version}}{{end}}{{end}}
---
{{/* content section */}}
<html>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
	...
	<h2 style="color: #1e90ff; margin-top: 0; font-size: 18px;">Your AgenticHub issue has been created</h2>
	...
	<h2 style="color: #1e90ff; margin-top: 0; font-size: 18px;">New comment on your AgenticHub issue</h2>
	...
	{{else}}
	<h2 style="color: #2e7d32; margin-top: 0; font-size: 18px;">Your AgenticHub issue has been resolved</h2>
	<p style="margin-bottom: 16px;">Thank you for your feedback. The following issue has been resolved{{if .resolved_issue_version}} in version {{.resolved_issue_version}}{{end}}:</p>
	<div style="margin: 24px 0; padding: 16px; background-color: #f1f8e9; border-left: 4px solid #2e7d32; border-radius: 4px;">
		<p style="margin: 0 0 8px 0; font-size: 12px; color: #666;">Issue #{{.issue_id}}</p>
		<p style="margin: 0; font-weight: bold;">{{.issue_title}}</p>
	</div>
	<p style="margin-top: 20px;">We appreciate your contribution to the AgenticHub.</p>
	{{end}}

	<p style="margin-top: 32px; padding-top: 16px; border-top: 1px solid #eee; font-size: 12px; color: #888;">AgenticHub Team</p>
</body>
</html>
