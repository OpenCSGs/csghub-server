{{/* title section */}}
{{if eq .event_type "create"}}Your AgenticHub issue has been created{{else if eq .event_type "comment"}}New comment on your AgenticHub issue #{{.issue_id}}{{else}}Your AgenticHub issue has been resolved{{end}}
---
{{/* content section */}}
<html>
