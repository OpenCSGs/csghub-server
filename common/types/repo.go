...
const (
	...
	AudioText2Video              PipelineTask = "audio-text-to-video"
	AudioImageText2Video         PipelineTask = "audio-image-text-to-video"
	AudioDrivenVideoContinuation PipelineTask = "audio-driven-video-continuation"
