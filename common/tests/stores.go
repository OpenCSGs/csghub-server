...
type MockStores struct {
	...
	AgentTemplate             database.AgentTemplateStore
}
...
func NewMockStores(t interface {
	...
	return &MockStores{
		...
		AgentTemplate:             mockdb.NewMockAgentTemplateStore(t),
	}
}

func (s *MockStores) AgentTemplateMock() *mockdb.MockAgentTemplateStore {
	return s.AgentTemplate.(*mockdb.MockAgentTemplateStore)
}
