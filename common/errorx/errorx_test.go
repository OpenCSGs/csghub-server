...
func Test_Err_Organization(t *testing.T) {
	...
	assert.Equal(t, "ORG-ERR-4", ErrOrganizationModeIncompatible.(CustomError).Code())
	assert.Equal(t, "ORG-ERR-5", ErrOrganizationAlreadyExists.(CustomError).Code())
	...
	assert.True(t, errors.Is(ErrOrganizationModeIncompatible, ErrOrganizationModeIncompatible))
	assert.True(t, errors.Is(ErrOrganizationAlreadyExists, ErrOrganizationAlreadyExists))
