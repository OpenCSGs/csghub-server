...
// BuildNotifyConsumerWithName provides a mock function with given fields: consumerName
func (_m *MockMessageQueue) BuildNotifyConsumerWithName(consumerName string) (jetstream.Consumer, error) {
	ret := _m.Called(consumerName)

	if len(ret) == 0 {
		panic("no return value specified for BuildNotifyConsumerWithName")
	}
...
// MockMessageQueue_BuildNotifyConsumerWithName_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BuildNotifyConsumerWithName'
type MockMessageQueue_BuildNotifyConsumerWithName_Call struct {
	*mock.Call
}

// BuildNotifyConsumerWithName is a helper method to define mock.On call
//   - consumerName string
func (_e *MockMessageQueue_Expecter) BuildNotifyConsumerWithName(consumerName interface{}) *MockMessageQueue_BuildNotifyConsumerWithName_Call {
	return &MockMessageQueue_BuildNotifyConsumerWithName_Call{Call: _e.mock.On("BuildNotifyConsumerWithName", consumerName)}
}

func (_c *MockMessageQueue_BuildNotifyConsumerWithName_Call) Run(run func(consumerName string)) *MockMessageQueue_BuildNotifyConsumerWithName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockMessageQueue_BuildNotifyConsumerWithName_Call) Return(_a0 jetstream.Consumer, _a1 error) *MockMessageQueue_BuildNotifyConsumerWithName_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMessageQueue_BuildNotifyConsumerWithName_Call) RunAndReturn(run func(string) (jetstream.Consumer, error)) *MockMessageQueue_BuildNotifyConsumerWithName_Call {
	_c.Call.Return(run)
	return _c
}

// BuildNotifyStream provides a mock function with no fields
func (_m *MockMessageQueue) BuildNotifyStream() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for BuildNotifyStream")
	}
...
// MockMessageQueue_BuildNotifyStream_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BuildNotifyStream'
type MockMessageQueue_BuildNotifyStream_Call struct {
	*mock.Call
}

// BuildNotifyStream is a helper method to define mock.On call
func (_e *MockMessageQueue_Expecter) BuildNotifyStream() *MockMessageQueue_BuildNotifyStream_Call {
	return &MockMessageQueue_BuildNotifyStream_Call{Call: _e.mock.On("BuildNotifyStream")}
}

func (_c *MockMessageQueue_BuildNotifyStream_Call) Run(run func()) *MockMessageQueue_BuildNotifyStream_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockMessageQueue_BuildNotifyStream_Call) Return(_a0 error) *MockMessageQueue_BuildNotifyStream_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockMessageQueue_BuildNotifyStream_Call) RunAndReturn(run func() error) *MockMessageQueue_BuildNotifyStream_Call {
	_c.Call.Return(run)
	return _c
}
...
// PublishNotificationForNoBalance provides a mock function with given fields: data
func (_m *MockMessageQueue) PublishNotificationForNoBalance(data []byte) error {
	ret := _m.Called(data)

	if len(ret) == 0 {
		panic("no return value specified for PublishNotificationForNoBalance")
	}
...
// MockMessageQueue_PublishNotificationForNoBalance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PublishNotificationForNoBalance'
type MockMessageQueue_PublishNotificationForNoBalance_Call struct {
	*mock.Call
}

// PublishNotificationForNoBalance is a helper method to define mock.On call
//   - data []byte
func (_e *MockMessageQueue_Expecter) PublishNotificationForNoBalance(data interface{}) *MockMessageQueue_PublishNotificationForNoBalance_Call {
	return &MockMessageQueue_PublishNotificationForNoBalance_Call{Call: _e.mock.On("PublishNotificationForNoBalance", data)}
}

func (_c *MockMessageQueue_PublishNotificationForNoBalance_Call) Run(run func(data []byte)) *MockMessageQueue_PublishNotificationForNoBalance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte))
	})
	return _c
...
func (_c *MockMessageQueue_PublishNotificationForNoBalance_Call) Return(_a0 error) *MockMessageQueue_PublishNotificationForNoBalance_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockMessageQueue_PublishNotificationForNoBalance_Call) RunAndReturn(run func([]byte) error) *MockMessageQueue_PublishNotificationForNoBalance_Call {
	_c.Call.Return(run)
	return _c
}
...
// VerifyNotifyStream provides a mock function with no fields
func (_m *MockMessageQueue) VerifyNotifyStream() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for VerifyNotifyStream")
	}
...
// MockMessageQueue_VerifyNotifyStream_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VerifyNotifyStream'
type MockMessageQueue_VerifyNotifyStream_Call struct {
	*mock.Call
}

// VerifyNotifyStream is a helper method to define mock.On call
func (_e *MockMessageQueue_Expecter) VerifyNotifyStream() *MockMessageQueue_VerifyNotifyStream_Call {
	return &MockMessageQueue_VerifyNotifyStream_Call{Call: _e.mock.On("VerifyNotifyStream")}
}

func (_c *MockMessageQueue_VerifyNotifyStream_Call) Run(run func()) *MockMessageQueue_VerifyNotifyStream_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockMessageQueue_VerifyNotifyStream_Call) Return(_a0 error) *MockMessageQueue_VerifyNotifyStream_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockMessageQueue_VerifyNotifyStream_Call) RunAndReturn(run func() error) *MockMessageQueue_VerifyNotifyStream_Call {
	_c.Call.Return(run)
	return _c
}
