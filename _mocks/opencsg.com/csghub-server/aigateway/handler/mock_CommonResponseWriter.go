...
// WithLLMTokenCounter provides a mock function with given fields: _a0
func (_m *MockCommonResponseWriter) WithLLMTokenCounter(_a0 *token.ChatTokenCounter) {
	_m.Called(_a0)
}

// MockCommonResponseWriter_WithLLMTokenCounter_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WithLLMTokenCounter'
type MockCommonResponseWriter_WithLLMTokenCounter_Call struct {
	*mock.Call
}

// WithLLMTokenCounter is a helper method to define mock.On call
//   - _a0 *token.ChatTokenCounter
func (_e *MockCommonResponseWriter_Expecter) WithLLMTokenCounter(_a0 interface{}) *MockCommonResponseWriter_WithLLMTokenCounter_Call {
	return &MockCommonResponseWriter_WithLLMTokenCounter_Call{Call: _e.mock.On("WithLLMTokenCounter", _a0)}
}

func (_c *MockCommonResponseWriter_WithLLMTokenCounter_Call) Run(run func(_a0 *token.ChatTokenCounter)) *MockCommonResponseWriter_WithLLMTokenCounter_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*token.ChatTokenCounter))
	})
	return _c
}

func (_c *MockCommonResponseWriter_WithLLMTokenCounter_Call) Return() *MockCommonResponseWriter_WithLLMTokenCounter_Call {
	_c.Call.Return()
	return _c
}
