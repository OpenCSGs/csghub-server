...
func (_m *MockTokenizer) Encode(_a0 string) (int64, error) {
	ret := _m.Called(_a0)
...
func (_c *MockTokenizer_Encode_Call) Run(run func(_a0 string)) *MockTokenizer_Encode_Call {
...
func (_c *MockTokenizer_Encode_Call) RunAndReturn(run func(string) (int64, error)) *MockTokenizer_Encode_Call {
	_c.Call.Return(run)
	return _c
}
