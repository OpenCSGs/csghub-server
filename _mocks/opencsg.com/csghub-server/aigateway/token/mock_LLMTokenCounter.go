...
func (_m *MockLLMTokenCounter) AppendPrompts(prompts ...string) {
...
func (_c *MockLLMTokenCounter_AppendPrompts_Call) Run(run func(prompts ...string)) *MockLLMTokenCounter_AppendPrompts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockLLMTokenCounter_AppendPrompts_Call) RunAndReturn(run func(...string)) *MockLLMTokenCounter_AppendPrompts_Call {
	_c.Run(run)
	return _c
}
