...
func (_m *MockRedisClient) GetDel(ctx context.Context, key string) (string, error) {
	ret := _m.Called(ctx, key)
...
// MockRedisClient_GetDel_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDel'
type MockRedisClient_GetDel_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - key string
func (_e *MockRedisClient_Expecter) GetDel(ctx interface{}, key interface{}) *MockRedisClient_GetDel_Call {
	return &MockRedisClient_GetDel_Call{Call: _e.mock.On("GetDel", ctx, key)}
}

func (_c *MockRedisClient_GetDel_Call) Run(run func(ctx context.Context, key string)) *MockRedisClient_GetDel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockRedisClient_GetDel_Call) Return(_a0 string, _a1 error) *MockRedisClient_GetDel_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRedisClient_GetDel_Call) RunAndReturn(run func(context.Context, string) (string, error)) *MockRedisClient_GetDel_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRedisClient) HExists(ctx context.Context, key string, field string) (bool, error) {
...
// MockRedisClient_HExists_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HExists'
type MockRedisClient_HExists_Call struct {
	*mock.Call
}
...
//   - key string
//   - field string
func (_e *MockRedisClient_Expecter) HExists(ctx interface{}, key interface{}, field interface{}) *MockRedisClient_HExists_Call {
	return &MockRedisClient_HExists_Call{Call: _e.mock.On("HExists", ctx, key, field)}
}

func (_c *MockRedisClient_HExists_Call) Run(run func(ctx context.Context, key string, field string)) *MockRedisClient_HExists_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRedisClient_HExists_Call) Return(_a0 bool, _a1 error) *MockRedisClient_HExists_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRedisClient_HExists_Call) RunAndReturn(run func(context.Context, string, string) (bool, error)) *MockRedisClient_HExists_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRedisClient) HLen(ctx context.Context, key string) (int64, error) {
	ret := _m.Called(ctx, key)
...
// MockRedisClient_HLen_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HLen'
type MockRedisClient_HLen_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - key string
func (_e *MockRedisClient_Expecter) HLen(ctx interface{}, key interface{}) *MockRedisClient_HLen_Call {
	return &MockRedisClient_HLen_Call{Call: _e.mock.On("HLen", ctx, key)}
}

func (_c *MockRedisClient_HLen_Call) Run(run func(ctx context.Context, key string)) *MockRedisClient_HLen_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockRedisClient_HLen_Call) Return(_a0 int64, _a1 error) *MockRedisClient_HLen_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRedisClient_HLen_Call) RunAndReturn(run func(context.Context, string) (int64, error)) *MockRedisClient_HLen_Call {
	_c.Call.Return(run)
	return _c
}
