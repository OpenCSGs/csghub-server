...
func (_m *MockLfsMetaObjectStore) ExistsByOidInActiveRepoExclRepo(ctx context.Context, oid string, repoID int64) (bool, error) {
	ret := _m.Called(ctx, oid, repoID)
...
// MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ExistsByOidInActiveRepoExclRepo'
type MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call struct {
	*mock.Call
}
...
//   - oid string
//   - repoID int64
func (_e *MockLfsMetaObjectStore_Expecter) ExistsByOidInActiveRepoExclRepo(ctx interface{}, oid interface{}, repoID interface{}) *MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call {
	return &MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call{Call: _e.mock.On("ExistsByOidInActiveRepoExclRepo", ctx, oid, repoID)}
}

func (_c *MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call) Run(run func(ctx context.Context, oid string, repoID int64)) *MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int64))
	})
	return _c
...
func (_c *MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call) Return(_a0 bool, _a1 error) *MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call) RunAndReturn(run func(context.Context, string, int64) (bool, error)) *MockLfsMetaObjectStore_ExistsByOidInActiveRepoExclRepo_Call {
	_c.Call.Return(run)
	return _c
}
