...
// ListAllDeployments provides a mock function with given fields: ctx, userID
func (_m *MockDeployTaskStore) ListAllDeployments(ctx context.Context, userID int64) ([]database.Deploy, error) {
	ret := _m.Called(ctx, userID)

	if len(ret) == 0 {
		panic("no return value specified for ListAllDeployments")
	}
...
// MockDeployTaskStore_ListAllDeployments_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListAllDeployments'
type MockDeployTaskStore_ListAllDeployments_Call struct {
	*mock.Call
}

// ListAllDeployments is a helper method to define mock.On call
//   - ctx context.Context
//   - userID int64
func (_e *MockDeployTaskStore_Expecter) ListAllDeployments(ctx interface{}, userID interface{}) *MockDeployTaskStore_ListAllDeployments_Call {
	return &MockDeployTaskStore_ListAllDeployments_Call{Call: _e.mock.On("ListAllDeployments", ctx, userID)}
}

func (_c *MockDeployTaskStore_ListAllDeployments_Call) Run(run func(ctx context.Context, userID int64)) *MockDeployTaskStore_ListAllDeployments_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
func (_c *MockDeployTaskStore_ListAllDeployments_Call) Return(_a0 []database.Deploy, _a1 error) *MockDeployTaskStore_ListAllDeployments_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDeployTaskStore_ListAllDeployments_Call) RunAndReturn(run func(context.Context, int64) ([]database.Deploy, error)) *MockDeployTaskStore_ListAllDeployments_Call {
	_c.Call.Return(run)
	return _c
}
