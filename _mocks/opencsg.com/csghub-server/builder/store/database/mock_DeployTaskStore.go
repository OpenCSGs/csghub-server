...
// CountByRepoID provides a mock function with given fields: ctx, repoID
func (_m *MockDeployTaskStore) CountByRepoID(ctx context.Context, repoID int64) (int, error) {
	ret := _m.Called(ctx, repoID)

	if len(ret) == 0 {
		panic("no return value specified for CountByRepoID")
	}
...
// MockDeployTaskStore_CountByRepoID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CountByRepoID'
type MockDeployTaskStore_CountByRepoID_Call struct {
	*mock.Call
}

// CountByRepoID is a helper method to define mock.On call
//   - ctx context.Context
//   - repoID int64
func (_e *MockDeployTaskStore_Expecter) CountByRepoID(ctx interface{}, repoID interface{}) *MockDeployTaskStore_CountByRepoID_Call {
	return &MockDeployTaskStore_CountByRepoID_Call{Call: _e.mock.On("CountByRepoID", ctx, repoID)}
}

func (_c *MockDeployTaskStore_CountByRepoID_Call) Run(run func(ctx context.Context, repoID int64)) *MockDeployTaskStore_CountByRepoID_Call {
...
func (_c *MockDeployTaskStore_CountByRepoID_Call) Return(_a0 int, _a1 error) *MockDeployTaskStore_CountByRepoID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDeployTaskStore_CountByRepoID_Call) RunAndReturn(run func(context.Context, int64) (int, error)) *MockDeployTaskStore_CountByRepoID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDeployTaskStore) FindActiveDeployByNameAndType(ctx context.Context, userUUID string, deployName string, deployType int) (*database.Deploy, error) {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, int) error); ok {
		r1 = rf(ctx, userUUID, deployName, deployType)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDeployTaskStore_FindActiveDeployByNameAndType_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindActiveDeployByNameAndType'
type MockDeployTaskStore_FindActiveDeployByNameAndType_Call struct {
	*mock.Call
}

// FindActiveDeployByNameAndType is a helper method to define mock.On call
//   - ctx context.Context
//   - userUUID string
//   - deployName string
//   - deployType int
func (_e *MockDeployTaskStore_Expecter) FindActiveDeployByNameAndType(ctx interface{}, userUUID interface{}, deployName interface{}, deployType interface{}) *MockDeployTaskStore_FindActiveDeployByNameAndType_Call {
	return &MockDeployTaskStore_FindActiveDeployByNameAndType_Call{Call: _e.mock.On("FindActiveDeployByNameAndType", ctx, userUUID, deployName, deployType)}
}

func (_c *MockDeployTaskStore_FindActiveDeployByNameAndType_Call) Run(run func(ctx context.Context, userUUID string, deployName string, deployType int)) *MockDeployTaskStore_FindActiveDeployByNameAndType_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDeployTaskStore_FindActiveDeployByNameAndType_Call) Return(_a0 *database.Deploy, _a1 error) *MockDeployTaskStore_FindActiveDeployByNameAndType_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDeployTaskStore_FindActiveDeployByNameAndType_Call) RunAndReturn(run func(context.Context, string, string, int) (*database.Deploy, error)) *MockDeployTaskStore_FindActiveDeployByNameAndType_Call {
	_c.Call.Return(run)
	return _c
}
...
// ListDeploysNeedingReconcile provides a mock function with given fields: ctx, statuses, timeoutMin, limit
func (_m *MockDeployTaskStore) ListDeploysNeedingReconcile(ctx context.Context, statuses []int, timeoutMin int, limit int) ([]database.Deploy, error) {
	ret := _m.Called(ctx, statuses, timeoutMin, limit)

	if len(ret) == 0 {
		panic("no return value specified for ListDeploysNeedingReconcile")
	}

	var r0 []database.Deploy
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []int, int, int) ([]database.Deploy, error)); ok {
		return rf(ctx, statuses, timeoutMin, limit)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []int, int, int) []database.Deploy); ok {
		r0 = rf(ctx, statuses, timeoutMin, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]database.Deploy)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, []int, int, int) error); ok {
		r1 = rf(ctx, statuses, timeoutMin, limit)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDeployTaskStore_ListDeploysNeedingReconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListDeploysNeedingReconcile'
type MockDeployTaskStore_ListDeploysNeedingReconcile_Call struct {
	*mock.Call
}

// ListDeploysNeedingReconcile is a helper method to define mock.On call
//   - ctx context.Context
//   - statuses []int
//   - timeoutMin int
//   - limit int
func (_e *MockDeployTaskStore_Expecter) ListDeploysNeedingReconcile(ctx interface{}, statuses interface{}, timeoutMin interface{}, limit interface{}) *MockDeployTaskStore_ListDeploysNeedingReconcile_Call {
	return &MockDeployTaskStore_ListDeploysNeedingReconcile_Call{Call: _e.mock.On("ListDeploysNeedingReconcile", ctx, statuses, timeoutMin, limit)}
}

func (_c *MockDeployTaskStore_ListDeploysNeedingReconcile_Call) Run(run func(ctx context.Context, statuses []int, timeoutMin int, limit int)) *MockDeployTaskStore_ListDeploysNeedingReconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDeployTaskStore_ListDeploysNeedingReconcile_Call) Return(_a0 []database.Deploy, _a1 error) *MockDeployTaskStore_ListDeploysNeedingReconcile_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDeployTaskStore_ListDeploysNeedingReconcile_Call) RunAndReturn(run func(context.Context, []int, int, int) ([]database.Deploy, error)) *MockDeployTaskStore_ListDeploysNeedingReconcile_Call {
	_c.Call.Return(run)
	return _c
}
