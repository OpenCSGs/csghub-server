...
// FindByParentPath provides a mock function with given fields: ctx, repoID, path
func (_m *MockFileStore) FindByParentPath(ctx context.Context, repoID int64, path string) ([]database.File, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, string) ([]database.File, error)); ok {
		return rf(ctx, repoID, path)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, string) []database.File); ok {
...
//   - repoID int64
//   - path string
func (_e *MockFileStore_Expecter) FindByParentPath(ctx interface{}, repoID interface{}, path interface{}) *MockFileStore_FindByParentPath_Call {
	return &MockFileStore_FindByParentPath_Call{Call: _e.mock.On("FindByParentPath", ctx, repoID, path)}
}

func (_c *MockFileStore_FindByParentPath_Call) Run(run func(ctx context.Context, repoID int64, path string)) *MockFileStore_FindByParentPath_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockFileStore_FindByParentPath_Call) RunAndReturn(run func(context.Context, int64, string) ([]database.File, error)) *MockFileStore_FindByParentPath_Call {
	_c.Call.Return(run)
	return _c
}
