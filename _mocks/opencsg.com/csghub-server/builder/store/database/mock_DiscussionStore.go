...
// CreateCommentWithMedia provides a mock function with given fields: ctx, comment, items
func (_m *MockDiscussionStore) CreateCommentWithMedia(ctx context.Context, comment database.Comment, items []types.CommentMediaItem) (*database.Comment, error) {
	ret := _m.Called(ctx, comment, items)

	if len(ret) == 0 {
		panic("no return value specified for CreateCommentWithMedia")
	}

	var r0 *database.Comment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, database.Comment, []types.CommentMediaItem) (*database.Comment, error)); ok {
		return rf(ctx, comment, items)
	}
	if rf, ok := ret.Get(0).(func(context.Context, database.Comment, []types.CommentMediaItem) *database.Comment); ok {
		r0 = rf(ctx, comment, items)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*database.Comment)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, database.Comment, []types.CommentMediaItem) error); ok {
		r1 = rf(ctx, comment, items)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDiscussionStore_CreateCommentWithMedia_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateCommentWithMedia'
type MockDiscussionStore_CreateCommentWithMedia_Call struct {
	*mock.Call
}

// CreateCommentWithMedia is a helper method to define mock.On call
//   - ctx context.Context
//   - comment database.Comment
//   - items []types.CommentMediaItem
func (_e *MockDiscussionStore_Expecter) CreateCommentWithMedia(ctx interface{}, comment interface{}, items interface{}) *MockDiscussionStore_CreateCommentWithMedia_Call {
	return &MockDiscussionStore_CreateCommentWithMedia_Call{Call: _e.mock.On("CreateCommentWithMedia", ctx, comment, items)}
}

func (_c *MockDiscussionStore_CreateCommentWithMedia_Call) Run(run func(ctx context.Context, comment database.Comment, items []types.CommentMediaItem)) *MockDiscussionStore_CreateCommentWithMedia_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(database.Comment), args[2].([]types.CommentMediaItem))
	})
	return _c
}

func (_c *MockDiscussionStore_CreateCommentWithMedia_Call) Return(_a0 *database.Comment, _a1 error) *MockDiscussionStore_CreateCommentWithMedia_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDiscussionStore_CreateCommentWithMedia_Call) RunAndReturn(run func(context.Context, database.Comment, []types.CommentMediaItem) (*database.Comment, error)) *MockDiscussionStore_CreateCommentWithMedia_Call {
	_c.Call.Return(run)
	return _c
}
...
// FindVisibleDiscussionComments provides a mock function with given fields: ctx, req
func (_m *MockDiscussionStore) FindVisibleDiscussionComments(ctx context.Context, req database.FindVisibleCommentsReq) ([]database.Comment, int, error) {
	ret := _m.Called(ctx, req)

	if len(ret) == 0 {
		panic("no return value specified for FindVisibleDiscussionComments")
	}

	var r0 []database.Comment
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, database.FindVisibleCommentsReq) ([]database.Comment, int, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, database.FindVisibleCommentsReq) []database.Comment); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]database.Comment)
	...
	if rf, ok := ret.Get(1).(func(context.Context, database.FindVisibleCommentsReq) int); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, database.FindVisibleCommentsReq) error); ok {
		r2 = rf(ctx, req)
	} else {
		r2 = ret.Error(2)
	}
...
// MockDiscussionStore_FindVisibleDiscussionComments_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindVisibleDiscussionComments'
type MockDiscussionStore_FindVisibleDiscussionComments_Call struct {
	*mock.Call
}

// FindVisibleDiscussionComments is a helper method to define mock.On call
//   - ctx context.Context
//   - req database.FindVisibleCommentsReq
func (_e *MockDiscussionStore_Expecter) FindVisibleDiscussionComments(ctx interface{}, req interface{}) *MockDiscussionStore_FindVisibleDiscussionComments_Call {
	return &MockDiscussionStore_FindVisibleDiscussionComments_Call{Call: _e.mock.On("FindVisibleDiscussionComments", ctx, req)}
}

func (_c *MockDiscussionStore_FindVisibleDiscussionComments_Call) Run(run func(ctx context.Context, req database.FindVisibleCommentsReq)) *MockDiscussionStore_FindVisibleDiscussionComments_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(database.FindVisibleCommentsReq))
	})
	return _c
}

func (_c *MockDiscussionStore_FindVisibleDiscussionComments_Call) Return(_a0 []database.Comment, _a1 int, _a2 error) *MockDiscussionStore_FindVisibleDiscussionComments_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockDiscussionStore_FindVisibleDiscussionComments_Call) RunAndReturn(run func(context.Context, database.FindVisibleCommentsReq) ([]database.Comment, int, error)) *MockDiscussionStore_FindVisibleDiscussionComments_Call {
	_c.Call.Return(run)
	return _c
}
