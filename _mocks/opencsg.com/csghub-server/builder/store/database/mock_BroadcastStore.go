...
//   - ctx context.Context
//   - id int64
func (_e *MockBroadcastStore_Expecter) Get(ctx interface{}, id int64) *MockBroadcastStore_Get_Call {
...
func (_e *MockBroadcastStore_Expecter) Save(ctx interface{}, broadcast database.Broadcast) *MockBroadcastStore_Save_Call {
