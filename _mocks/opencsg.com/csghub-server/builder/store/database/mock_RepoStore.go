...
// PublicToUserV2WithAccess provides a mock function with given fields: ctx, repoType, scope, filter, per, page
func (_m *MockRepoStore) PublicToUserV2WithAccess(ctx context.Context, repoType types.RepositoryType, scope database.RepositoryAccessScope, filter *types.RepoFilter, per int, page int) ([]*database.Repository, int, error) {
	ret := _m.Called(ctx, repoType, scope, filter, per, page)

	if len(ret) == 0 {
		panic("no return value specified for PublicToUserV2WithAccess")
	}

	var r0 []*database.Repository
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, types.RepositoryType, database.RepositoryAccessScope, *types.RepoFilter, int, int) ([]*database.Repository, int, error)); ok {
		return rf(ctx, repoType, scope, filter, per, page)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.RepositoryType, database.RepositoryAccessScope, *types.RepoFilter, int, int) []*database.Repository); ok {
		r0 = rf(ctx, repoType, scope, filter, per, page)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*database.Repository)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, types.RepositoryType, database.RepositoryAccessScope, *types.RepoFilter, int, int) int); ok {
		r1 = rf(ctx, repoType, scope, filter, per, page)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, types.RepositoryType, database.RepositoryAccessScope, *types.RepoFilter, int, int) error); ok {
		r2 = rf(ctx, repoType, scope, filter, per, page)
	} else {
		r2 = ret.Error(2)
	}
...
// MockRepoStore_PublicToUserV2WithAccess_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PublicToUserV2WithAccess'
type MockRepoStore_PublicToUserV2WithAccess_Call struct {
	*mock.Call
}

// PublicToUserV2WithAccess is a helper method to define mock.On call
//   - ctx context.Context
//   - repoType types.RepositoryType
//   - scope database.RepositoryAccessScope
//   - filter *types.RepoFilter
//   - per int
//   - page int
func (_e *MockRepoStore_Expecter) PublicToUserV2WithAccess(ctx interface{}, repoType interface{}, scope interface{}, filter interface{}, per interface{}, page interface{}) *MockRepoStore_PublicToUserV2WithAccess_Call {
	return &MockRepoStore_PublicToUserV2WithAccess_Call{Call: _e.mock.On("PublicToUserV2WithAccess", ctx, repoType, scope, filter, per, page)}
}

func (_c *MockRepoStore_PublicToUserV2WithAccess_Call) Run(run func(ctx context.Context, repoType types.RepositoryType, scope database.RepositoryAccessScope, filter *types.RepoFilter, per int, page int)) *MockRepoStore_PublicToUserV2WithAccess_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.RepositoryType), args[2].(database.RepositoryAccessScope), args[3].(*types.RepoFilter), args[4].(int), args[5].(int))
	})
	return _c
}

func (_c *MockRepoStore_PublicToUserV2WithAccess_Call) Return(repos []*database.Repository, count int, err error) *MockRepoStore_PublicToUserV2WithAccess_Call {
	_c.Call.Return(repos, count, err)
	return _c
}

func (_c *MockRepoStore_PublicToUserV2WithAccess_Call) RunAndReturn(run func(context.Context, types.RepositoryType, database.RepositoryAccessScope, *types.RepoFilter, int, int) ([]*database.Repository, int, error)) *MockRepoStore_PublicToUserV2WithAccess_Call {
	_c.Call.Return(run)
	return _c
}

// PublicToUserWithAccess provides a mock function with given fields: ctx, repoType, scope, filter, per, page
func (_m *MockRepoStore) PublicToUserWithAccess(ctx context.Context, repoType types.RepositoryType, scope database.RepositoryAccessScope, filter *types.RepoFilter, per int, page int) ([]*database.Repository, int, error) {
	ret := _m.Called(ctx, repoType, scope, filter, per, page)

	if len(ret) == 0 {
		panic("no return value specified for PublicToUserWithAccess")
	}
...
// MockRepoStore_PublicToUserWithAccess_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PublicToUserWithAccess'
type MockRepoStore_PublicToUserWithAccess_Call struct {
	*mock.Call
}

// PublicToUserWithAccess is a helper method to define mock.On call
//   - ctx context.Context
//   - repoType types.RepositoryType
//   - scope database.RepositoryAccessScope
//   - filter *types.RepoFilter
//   - per int
//   - page int
func (_e *MockRepoStore_Expecter) PublicToUserWithAccess(ctx interface{}, repoType interface{}, scope interface{}, filter interface{}, per interface{}, page interface{}) *MockRepoStore_PublicToUserWithAccess_Call {
	return &MockRepoStore_PublicToUserWithAccess_Call{Call: _e.mock.On("PublicToUserWithAccess", ctx, repoType, scope, filter, per, page)}
}

func (_c *MockRepoStore_PublicToUserWithAccess_Call) Run(run func(ctx context.Context, repoType types.RepositoryType, scope database.RepositoryAccessScope, filter *types.RepoFilter, per int, page int)) *MockRepoStore_PublicToUserWithAccess_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.RepositoryType), args[2].(database.RepositoryAccessScope), args[3].(*types.RepoFilter), args[4].(int), args[5].(int))
	})
	return _c
...
func (_c *MockRepoStore_PublicToUserWithAccess_Call) Return(repos []*database.Repository, count int, err error) *MockRepoStore_PublicToUserWithAccess_Call {
	_c.Call.Return(repos, count, err)
	return _c
}

func (_c *MockRepoStore_PublicToUserWithAccess_Call) RunAndReturn(run func(context.Context, types.RepositoryType, database.RepositoryAccessScope, *types.RepoFilter, int, int) ([]*database.Repository, int, error)) *MockRepoStore_PublicToUserWithAccess_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateLicenseCompliance provides a mock function with given fields: ctx, repoID, license, status, permission
func (_m *MockRepoStore) UpdateLicenseCompliance(ctx context.Context, repoID int64, license *string, status types.ComplianceStatus, permission types.CommercialPermission) error {
	ret := _m.Called(ctx, repoID, license, status, permission)

	if len(ret) == 0 {
		panic("no return value specified for UpdateLicenseCompliance")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, *string, types.ComplianceStatus, types.CommercialPermission) error); ok {
		r0 = rf(ctx, repoID, license, status, permission)
	} else {
		r0 = ret.Error(0)
	}
...
// MockRepoStore_UpdateLicenseCompliance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateLicenseCompliance'
type MockRepoStore_UpdateLicenseCompliance_Call struct {
	*mock.Call
}

// UpdateLicenseCompliance is a helper method to define mock.On call
//   - ctx context.Context
//   - repoID int64
//   - license *string
//   - status types.ComplianceStatus
//   - permission types.CommercialPermission
func (_e *MockRepoStore_Expecter) UpdateLicenseCompliance(ctx interface{}, repoID interface{}, license interface{}, status interface{}, permission interface{}) *MockRepoStore_UpdateLicenseCompliance_Call {
	return &MockRepoStore_UpdateLicenseCompliance_Call{Call: _e.mock.On("UpdateLicenseCompliance", ctx, repoID, license, status, permission)}
}

func (_c *MockRepoStore_UpdateLicenseCompliance_Call) Run(run func(ctx context.Context, repoID int64, license *string, status types.ComplianceStatus, permission types.CommercialPermission)) *MockRepoStore_UpdateLicenseCompliance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(*string), args[3].(types.ComplianceStatus), args[4].(types.CommercialPermission))
	})
	return _c
}

func (_c *MockRepoStore_UpdateLicenseCompliance_Call) Return(_a0 error) *MockRepoStore_UpdateLicenseCompliance_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRepoStore_UpdateLicenseCompliance_Call) RunAndReturn(run func(context.Context, int64, *string, types.ComplianceStatus, types.CommercialPermission) error) *MockRepoStore_UpdateLicenseCompliance_Call {
	_c.Call.Return(run)
	return _c
}
