...
func (_m *MockLLMConfigStore) GetByModelName(ctx context.Context, modelName string) (*database.LLMConfig, error) {
...
// MockLLMConfigStore_GetByModelName_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByModelName'
type MockLLMConfigStore_GetByModelName_Call struct {
	*mock.Call
}

// GetByModelName is a helper method to define mock.On call
//   - ctx context.Context
//   - modelName string
func (_e *MockLLMConfigStore_Expecter) GetByModelName(ctx interface{}, modelName interface{}) *MockLLMConfigStore_GetByModelName_Call {
	return &MockLLMConfigStore_GetByModelName_Call{Call: _e.mock.On("GetByModelName", ctx, modelName)}
}

func (_c *MockLLMConfigStore_GetByModelName_Call) Run(run func(ctx context.Context, modelName string)) *MockLLMConfigStore_GetByModelName_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockLLMConfigStore_GetByModelName_Call) Return(_a0 *database.LLMConfig, _a1 error) *MockLLMConfigStore_GetByModelName_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockLLMConfigStore_GetByModelName_Call) RunAndReturn(run func(context.Context, string) (*database.LLMConfig, error)) *MockLLMConfigStore_GetByModelName_Call {
	_c.Call.Return(run)
	return _c
}
