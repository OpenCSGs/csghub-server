...
func (_m *MockAccountSyncQuotaStatementStore) CountByRepoPath(ctx context.Context, repoPath string) (int, error) {
...
// MockAccountSyncQuotaStatementStore_CountByRepoPath_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CountByRepoPath'
type MockAccountSyncQuotaStatementStore_CountByRepoPath_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - repoPath string
func (_e *MockAccountSyncQuotaStatementStore_Expecter) CountByRepoPath(ctx interface{}, repoPath interface{}) *MockAccountSyncQuotaStatementStore_CountByRepoPath_Call {
	return &MockAccountSyncQuotaStatementStore_CountByRepoPath_Call{Call: _e.mock.On("CountByRepoPath", ctx, repoPath)}
}

func (_c *MockAccountSyncQuotaStatementStore_CountByRepoPath_Call) Run(run func(ctx context.Context, repoPath string)) *MockAccountSyncQuotaStatementStore_CountByRepoPath_Call {
...
func (_c *MockAccountSyncQuotaStatementStore_CountByRepoPath_Call) Return(_a0 int, _a1 error) *MockAccountSyncQuotaStatementStore_CountByRepoPath_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAccountSyncQuotaStatementStore_CountByRepoPath_Call) RunAndReturn(run func(context.Context, string) (int, error)) *MockAccountSyncQuotaStatementStore_CountByRepoPath_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAccountSyncQuotaStatementStore) Get(ctx context.Context, userID int64, req types.AcctQuotaStatementReq) (*database.AccountSyncQuotaStatement, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, types.AcctQuotaStatementReq) (*database.AccountSyncQuotaStatement, error)); ok {
		return rf(ctx, userID, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, types.AcctQuotaStatementReq) *database.AccountSyncQuotaStatement); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, int64, types.AcctQuotaStatementReq) error); ok {
...
func (_c *MockAccountSyncQuotaStatementStore_Get_Call) Run(run func(ctx context.Context, userID int64, req types.AcctQuotaStatementReq)) *MockAccountSyncQuotaStatementStore_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(types.AcctQuotaStatementReq))
	})
	return _c
}
...
func (_c *MockAccountSyncQuotaStatementStore_Get_Call) RunAndReturn(run func(context.Context, int64, types.AcctQuotaStatementReq) (*database.AccountSyncQuotaStatement, error)) *MockAccountSyncQuotaStatementStore_Get_Call {
	_c.Call.Return(run)
	return _c
}
