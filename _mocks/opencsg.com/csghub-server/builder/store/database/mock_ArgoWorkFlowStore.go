...
// ListWorkflowsNeedingReconcile provides a mock function with given fields: ctx, statuses, timeoutMin, limit
func (_m *MockArgoWorkFlowStore) ListWorkflowsNeedingReconcile(ctx context.Context, statuses []v1alpha1.WorkflowPhase, timeoutMin int, limit int) ([]database.ArgoWorkflow, error) {
	ret := _m.Called(ctx, statuses, timeoutMin, limit)

	if len(ret) == 0 {
		panic("no return value specified for ListWorkflowsNeedingReconcile")
	}

	var r0 []database.ArgoWorkflow
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []v1alpha1.WorkflowPhase, int, int) ([]database.ArgoWorkflow, error)); ok {
		return rf(ctx, statuses, timeoutMin, limit)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []v1alpha1.WorkflowPhase, int, int) []database.ArgoWorkflow); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []v1alpha1.WorkflowPhase, int, int) error); ok {
...
// MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListWorkflowsNeedingReconcile'
type MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call struct {
	*mock.Call
}

// ListWorkflowsNeedingReconcile is a helper method to define mock.On call
//   - ctx context.Context
//   - statuses []v1alpha1.WorkflowPhase
//   - timeoutMin int
//   - limit int
func (_e *MockArgoWorkFlowStore_Expecter) ListWorkflowsNeedingReconcile(ctx interface{}, statuses interface{}, timeoutMin interface{}, limit interface{}) *MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call {
	return &MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call{Call: _e.mock.On("ListWorkflowsNeedingReconcile", ctx, statuses, timeoutMin, limit)}
}

func (_c *MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call) Run(run func(ctx context.Context, statuses []v1alpha1.WorkflowPhase, timeoutMin int, limit int)) *MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]v1alpha1.WorkflowPhase), args[2].(int), args[3].(int))
	})
	return _c
}

func (_c *MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call) Return(_a0 []database.ArgoWorkflow, _a1 error) *MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call) RunAndReturn(run func(context.Context, []v1alpha1.WorkflowPhase, int, int) ([]database.ArgoWorkflow, error)) *MockArgoWorkFlowStore_ListWorkflowsNeedingReconcile_Call {
	_c.Call.Return(run)
	return _c
}
