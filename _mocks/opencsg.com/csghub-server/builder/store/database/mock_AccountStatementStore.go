...
func (_m *MockAccountStatementStore) Create(ctx context.Context, input database.AccountStatement, extra types.AcctStatementExtra) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, database.AccountStatement, types.AcctStatementExtra) error); ok {
...
//   - extra types.AcctStatementExtra
func (_e *MockAccountStatementStore_Expecter) Create(ctx interface{}, input interface{}, extra interface{}) *MockAccountStatementStore_Create_Call {
	return &MockAccountStatementStore_Create_Call{Call: _e.mock.On("Create", ctx, input, extra)}
}

func (_c *MockAccountStatementStore_Create_Call) Run(run func(ctx context.Context, input database.AccountStatement, extra types.AcctStatementExtra)) *MockAccountStatementStore_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(database.AccountStatement), args[2].(types.AcctStatementExtra))
	})
	return _c
}
...
func (_c *MockAccountStatementStore_Create_Call) RunAndReturn(run func(context.Context, database.AccountStatement, types.AcctStatementExtra) error) *MockAccountStatementStore_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetDeductionSummaryByUserSceneCustomer provides a mock function with given fields: ctx, input
func (_m *MockAccountStatementStore) GetDeductionSummaryByUserSceneCustomer(ctx context.Context, input database.AccountStatement) (*types.DeductionSummary, error) {
	ret := _m.Called(ctx, input)

	if len(ret) == 0 {
		panic("no return value specified for GetDeductionSummaryByUserSceneCustomer")
	}

	var r0 *types.DeductionSummary
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, database.AccountStatement) (*types.DeductionSummary, error)); ok {
		return rf(ctx, input)
	}
	if rf, ok := ret.Get(0).(func(context.Context, database.AccountStatement) *types.DeductionSummary); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.DeductionSummary)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, database.AccountStatement) error); ok {
		r1 = rf(ctx, input)
	} else {
		r1 = ret.Error(1)
	}
...
// MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDeductionSummaryByUserSceneCustomer'
type MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call struct {
	*mock.Call
}

// GetDeductionSummaryByUserSceneCustomer is a helper method to define mock.On call
//   - ctx context.Context
//   - input database.AccountStatement
func (_e *MockAccountStatementStore_Expecter) GetDeductionSummaryByUserSceneCustomer(ctx interface{}, input interface{}) *MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call {
	return &MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call{Call: _e.mock.On("GetDeductionSummaryByUserSceneCustomer", ctx, input)}
}

func (_c *MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call) Run(run func(ctx context.Context, input database.AccountStatement)) *MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call) Return(_a0 *types.DeductionSummary, _a1 error) *MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call) RunAndReturn(run func(context.Context, database.AccountStatement) (*types.DeductionSummary, error)) *MockAccountStatementStore_GetDeductionSummaryByUserSceneCustomer_Call {
	_c.Call.Return(run)
	return _c
}
...
// MinCreatedAt provides a mock function with given fields: ctx
func (_m *MockAccountStatementStore) MinCreatedAt(ctx context.Context) (time.Time, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for MinCreatedAt")
	}
...
// MockAccountStatementStore_MinCreatedAt_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MinCreatedAt'
type MockAccountStatementStore_MinCreatedAt_Call struct {
	*mock.Call
}

// MinCreatedAt is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockAccountStatementStore_Expecter) MinCreatedAt(ctx interface{}) *MockAccountStatementStore_MinCreatedAt_Call {
	return &MockAccountStatementStore_MinCreatedAt_Call{Call: _e.mock.On("MinCreatedAt", ctx)}
}

func (_c *MockAccountStatementStore_MinCreatedAt_Call) Run(run func(ctx context.Context)) *MockAccountStatementStore_MinCreatedAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAccountStatementStore_MinCreatedAt_Call) Return(_a0 time.Time, _a1 error) *MockAccountStatementStore_MinCreatedAt_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAccountStatementStore_MinCreatedAt_Call) RunAndReturn(run func(context.Context) (time.Time, error)) *MockAccountStatementStore_MinCreatedAt_Call {
	_c.Call.Return(run)
	return _c
}
