...
func (_m *MockSSOInterface) CreateUser(ctx context.Context, userInfo *rpc.SSOCreateUserInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *rpc.SSOCreateUserInfo) error); ok {
		r0 = rf(ctx, userInfo)
	} else {
		r0 = ret.Error(0)
	}
...
// MockSSOInterface_CreateUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateUser'
type MockSSOInterface_CreateUser_Call struct {
	*mock.Call
}

// CreateUser is a helper method to define mock.On call
//   - ctx context.Context
//   - userInfo *rpc.SSOCreateUserInfo
func (_e *MockSSOInterface_Expecter) CreateUser(ctx interface{}, userInfo interface{}) *MockSSOInterface_CreateUser_Call {
	return &MockSSOInterface_CreateUser_Call{Call: _e.mock.On("CreateUser", ctx, userInfo)}
}

func (_c *MockSSOInterface_CreateUser_Call) Run(run func(ctx context.Context, userInfo *rpc.SSOCreateUserInfo)) *MockSSOInterface_CreateUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*rpc.SSOCreateUserInfo))
	})
	return _c
}

func (_c *MockSSOInterface_CreateUser_Call) Return(_a0 error) *MockSSOInterface_CreateUser_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSSOInterface_CreateUser_Call) RunAndReturn(run func(context.Context, *rpc.SSOCreateUserInfo) error) *MockSSOInterface_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
