...
func (_m *MockModerationSvcClient) QueryMediaModerationResult(ctx context.Context, req types.MediaModerationRequest) (*types.MediaModerationResult, error) {
	ret := _m.Called(ctx, req)
...
// MockModerationSvcClient_QueryMediaModerationResult_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'QueryMediaModerationResult'
type MockModerationSvcClient_QueryMediaModerationResult_Call struct {
	*mock.Call
}
...
func (_e *MockModerationSvcClient_Expecter) QueryMediaModerationResult(ctx interface{}, req interface{}) *MockModerationSvcClient_QueryMediaModerationResult_Call {
	return &MockModerationSvcClient_QueryMediaModerationResult_Call{Call: _e.mock.On("QueryMediaModerationResult", ctx, req)}
}

func (_c *MockModerationSvcClient_QueryMediaModerationResult_Call) Run(run func(ctx context.Context, req types.MediaModerationRequest)) *MockModerationSvcClient_QueryMediaModerationResult_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockModerationSvcClient_QueryMediaModerationResult_Call) Return(_a0 *types.MediaModerationResult, _a1 error) *MockModerationSvcClient_QueryMediaModerationResult_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockModerationSvcClient_QueryMediaModerationResult_Call) RunAndReturn(run func(context.Context, types.MediaModerationRequest) (*types.MediaModerationResult, error)) *MockModerationSvcClient_QueryMediaModerationResult_Call {
	_c.Call.Return(run)
	return _c
}

// SubmitMediaModeration provides a mock function with given fields: ctx, req
func (_m *MockModerationSvcClient) SubmitMediaModeration(ctx context.Context, req types.MediaModerationRequest) (*types.MediaModerationSubmission, error) {
	ret := _m.Called(ctx, req)
...
// MockModerationSvcClient_SubmitMediaModeration_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SubmitMediaModeration'
type MockModerationSvcClient_SubmitMediaModeration_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - req types.MediaModerationRequest
func (_e *MockModerationSvcClient_Expecter) SubmitMediaModeration(ctx interface{}, req interface{}) *MockModerationSvcClient_SubmitMediaModeration_Call {
	return &MockModerationSvcClient_SubmitMediaModeration_Call{Call: _e.mock.On("SubmitMediaModeration", ctx, req)}
}

func (_c *MockModerationSvcClient_SubmitMediaModeration_Call) Run(run func(ctx context.Context, req types.MediaModerationRequest)) *MockModerationSvcClient_SubmitMediaModeration_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.MediaModerationRequest))
	})
	return _c
...
func (_c *MockModerationSvcClient_SubmitMediaModeration_Call) Return(_a0 *types.MediaModerationSubmission, _a1 error) *MockModerationSvcClient_SubmitMediaModeration_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockModerationSvcClient_SubmitMediaModeration_Call) RunAndReturn(run func(context.Context, types.MediaModerationRequest) (*types.MediaModerationSubmission, error)) *MockModerationSvcClient_SubmitMediaModeration_Call {
	_c.Call.Return(run)
	return _c
}
