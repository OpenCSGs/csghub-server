...
// GetOrCreateBuiltinAPIKey provides a mock function with given fields: ctx, userName, nsUUID
func (_m *MockUserSvcClient) GetOrCreateBuiltinAPIKey(ctx context.Context, userName string, nsUUID string) (string, error) {
	ret := _m.Called(ctx, userName, nsUUID)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (string, error)); ok {
		return rf(ctx, userName, nsUUID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) string); ok {
		r0 = rf(ctx, userName, nsUUID)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string) error); ok {
		r1 = rf(ctx, userName, nsUUID)
	} else {
		r1 = ret.Error(1)
	}
...
// MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOrCreateBuiltinAPIKey'
type MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call struct {
	*mock.Call
}
...
//   - userName string
//   - nsUUID string
func (_e *MockUserSvcClient_Expecter) GetOrCreateBuiltinAPIKey(ctx interface{}, userName interface{}, nsUUID interface{}) *MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call {
	return &MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call{Call: _e.mock.On("GetOrCreateBuiltinAPIKey", ctx, userName, nsUUID)}
}

func (_c *MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call) Run(run func(ctx context.Context, userName string, nsUUID string)) *MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call) Return(_a0 string, _a1 error) *MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call) RunAndReturn(run func(context.Context, string, string) (string, error)) *MockUserSvcClient_GetOrCreateBuiltinAPIKey_Call {
	_c.Call.Return(run)
	return _c
}
