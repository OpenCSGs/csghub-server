...
// GetArchitectureFromConfig provides a mock function with given fields: ctx, namespace, name
func (_m *MockRuntimeArchitectureComponent) GetArchitectureFromConfig(ctx context.Context, namespace string, name string) (string, error) {
	ret := _m.Called(ctx, namespace, name)

	if len(ret) == 0 {
		panic("no return value specified for GetArchitectureFromConfig")
	}
...
// MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetArchitectureFromConfig'
type MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call struct {
	*mock.Call
}

// GetArchitectureFromConfig is a helper method to define mock.On call
//   - ctx context.Context
//   - namespace string
//   - name string
func (_e *MockRuntimeArchitectureComponent_Expecter) GetArchitectureFromConfig(ctx interface{}, namespace interface{}, name interface{}) *MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call {
	return &MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call{Call: _e.mock.On("GetArchitectureFromConfig", ctx, namespace, name)}
}

func (_c *MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call) Run(run func(ctx context.Context, namespace string, name string)) *MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call) Return(_a0 string, _a1 error) *MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call) RunAndReturn(run func(context.Context, string, string) (string, error)) *MockRuntimeArchitectureComponent_GetArchitectureFromConfig_Call {
	_c.Call.Return(run)
	return _c
}
...
// ScanArchitecture provides a mock function with given fields: ctx, id, scanType, models
func (_m *MockRuntimeArchitectureComponent) ScanArchitecture(ctx context.Context, id int64, scanType int, models []string) error {
	ret := _m.Called(ctx, id, scanType, models)
...
//   - scanType int
//   - models []string
func (_e *MockRuntimeArchitectureComponent_Expecter) ScanArchitecture(ctx interface{}, id interface{}, scanType interface{}, models interface{}) *MockRuntimeArchitectureComponent_ScanArchitecture_Call {
	return &MockRuntimeArchitectureComponent_ScanArchitecture_Call{Call: _e.mock.On("ScanArchitecture", ctx, id, scanType, models)}
}

func (_c *MockRuntimeArchitectureComponent_ScanArchitecture_Call) Run(run func(ctx context.Context, id int64, scanType int, models []string)) *MockRuntimeArchitectureComponent_ScanArchitecture_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRuntimeArchitectureComponent_ScanArchitecture_Call) RunAndReturn(run func(context.Context, int64, int, []string) error) *MockRuntimeArchitectureComponent_ScanArchitecture_Call {
	_c.Call.Return(run)
	return _c
}
