...
// CheckImageURL provides a mock function with given fields: ctx, scenario, imageURL
func (_m *MockSensitiveComponent) CheckImageURL(ctx context.Context, scenario types.SensitiveScenario, imageURL string) (bool, error) {
	ret := _m.Called(ctx, scenario, imageURL)

	if len(ret) == 0 {
		panic("no return value specified for CheckImageURL")
	}
...
// MockSensitiveComponent_CheckImageURL_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckImageURL'
type MockSensitiveComponent_CheckImageURL_Call struct {
	*mock.Call
}

// CheckImageURL is a helper method to define mock.On call
//   - ctx context.Context
//   - scenario types.SensitiveScenario
//   - imageURL string
func (_e *MockSensitiveComponent_Expecter) CheckImageURL(ctx interface{}, scenario interface{}, imageURL interface{}) *MockSensitiveComponent_CheckImageURL_Call {
	return &MockSensitiveComponent_CheckImageURL_Call{Call: _e.mock.On("CheckImageURL", ctx, scenario, imageURL)}
}

func (_c *MockSensitiveComponent_CheckImageURL_Call) Run(run func(ctx context.Context, scenario types.SensitiveScenario, imageURL string)) *MockSensitiveComponent_CheckImageURL_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSensitiveComponent_CheckImageURL_Call) Return(_a0 bool, _a1 error) *MockSensitiveComponent_CheckImageURL_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSensitiveComponent_CheckImageURL_Call) RunAndReturn(run func(context.Context, types.SensitiveScenario, string) (bool, error)) *MockSensitiveComponent_CheckImageURL_Call {
	_c.Call.Return(run)
	return _c
}
