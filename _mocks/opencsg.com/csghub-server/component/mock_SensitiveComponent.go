...
func (_c *MockSensitiveComponent_CheckMarkdownContent_Call) RunAndReturn(run func(context.Context, string) (bool, error)) *MockSensitiveComponent_CheckMarkdownContent_Call {
	_c.Call.Return(run)
	return _c
}
