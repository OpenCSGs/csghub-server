...
// CheckCommentOwnership provides a mock function with given fields: ctx, currentUser, id
func (_m *MockDiscussionComponent) CheckCommentOwnership(ctx context.Context, currentUser string, id int64) error {
	ret := _m.Called(ctx, currentUser, id)

	if len(ret) == 0 {
		panic("no return value specified for CheckCommentOwnership")
	}
...
// MockDiscussionComponent_CheckCommentOwnership_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckCommentOwnership'
type MockDiscussionComponent_CheckCommentOwnership_Call struct {
	*mock.Call
}

// CheckCommentOwnership is a helper method to define mock.On call
//   - ctx context.Context
//   - currentUser string
//   - id int64
func (_e *MockDiscussionComponent_Expecter) CheckCommentOwnership(ctx interface{}, currentUser interface{}, id interface{}) *MockDiscussionComponent_CheckCommentOwnership_Call {
	return &MockDiscussionComponent_CheckCommentOwnership_Call{Call: _e.mock.On("CheckCommentOwnership", ctx, currentUser, id)}
}

func (_c *MockDiscussionComponent_CheckCommentOwnership_Call) Run(run func(ctx context.Context, currentUser string, id int64)) *MockDiscussionComponent_CheckCommentOwnership_Call {
...
func (_c *MockDiscussionComponent_CheckCommentOwnership_Call) Return(_a0 error) *MockDiscussionComponent_CheckCommentOwnership_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockDiscussionComponent_CheckCommentOwnership_Call) RunAndReturn(run func(context.Context, string, int64) error) *MockDiscussionComponent_CheckCommentOwnership_Call {
	_c.Call.Return(run)
	return _c
}

// CheckDiscussionCommentAccess provides a mock function with given fields: ctx, currentUser, discussionID
func (_m *MockDiscussionComponent) CheckDiscussionCommentAccess(ctx context.Context, currentUser string, discussionID int64) error {
	ret := _m.Called(ctx, currentUser, discussionID)

	if len(ret) == 0 {
		panic("no return value specified for CheckDiscussionCommentAccess")
	}
...
// MockDiscussionComponent_CheckDiscussionCommentAccess_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckDiscussionCommentAccess'
type MockDiscussionComponent_CheckDiscussionCommentAccess_Call struct {
	*mock.Call
}

// CheckDiscussionCommentAccess is a helper method to define mock.On call
//   - ctx context.Context
//   - currentUser string
//   - discussionID int64
func (_e *MockDiscussionComponent_Expecter) CheckDiscussionCommentAccess(ctx interface{}, currentUser interface{}, discussionID interface{}) *MockDiscussionComponent_CheckDiscussionCommentAccess_Call {
	return &MockDiscussionComponent_CheckDiscussionCommentAccess_Call{Call: _e.mock.On("CheckDiscussionCommentAccess", ctx, currentUser, discussionID)}
}

func (_c *MockDiscussionComponent_CheckDiscussionCommentAccess_Call) Run(run func(ctx context.Context, currentUser string, discussionID int64)) *MockDiscussionComponent_CheckDiscussionCommentAccess_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int64))
	})
	return _c
...
func (_c *MockDiscussionComponent_CheckDiscussionCommentAccess_Call) Return(_a0 error) *MockDiscussionComponent_CheckDiscussionCommentAccess_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockDiscussionComponent_CheckDiscussionCommentAccess_Call) RunAndReturn(run func(context.Context, string, int64) error) *MockDiscussionComponent_CheckDiscussionCommentAccess_Call {
	_c.Call.Return(run)
	return _c
}

// CommentUnderModeration provides a mock function with given fields: ctx, commentID
func (_m *MockDiscussionComponent) CommentUnderModeration(ctx context.Context, commentID int64) (bool, error) {
	ret := _m.Called(ctx, commentID)

	if len(ret) == 0 {
		panic("no return value specified for CommentUnderModeration")
	}
...
// MockDiscussionComponent_CommentUnderModeration_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CommentUnderModeration'
type MockDiscussionComponent_CommentUnderModeration_Call struct {
	*mock.Call
}

// CommentUnderModeration is a helper method to define mock.On call
//   - ctx context.Context
//   - commentID int64
func (_e *MockDiscussionComponent_Expecter) CommentUnderModeration(ctx interface{}, commentID interface{}) *MockDiscussionComponent_CommentUnderModeration_Call {
	return &MockDiscussionComponent_CommentUnderModeration_Call{Call: _e.mock.On("CommentUnderModeration", ctx, commentID)}
}

func (_c *MockDiscussionComponent_CommentUnderModeration_Call) Run(run func(ctx context.Context, commentID int64)) *MockDiscussionComponent_CommentUnderModeration_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDiscussionComponent_CommentUnderModeration_Call) Return(_a0 bool, _a1 error) *MockDiscussionComponent_CommentUnderModeration_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDiscussionComponent_CommentUnderModeration_Call) RunAndReturn(run func(context.Context, int64) (bool, error)) *MockDiscussionComponent_CommentUnderModeration_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDiscussionComponent) LinkCommentMedia(ctx context.Context, commentID int64, items []types.CommentMediaItem) error {
...
// MockDiscussionComponent_LinkCommentMedia_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LinkCommentMedia'
type MockDiscussionComponent_LinkCommentMedia_Call struct {
	*mock.Call
}
...
func (_e *MockDiscussionComponent_Expecter) LinkCommentMedia(ctx interface{}, commentID interface{}, items interface{}) *MockDiscussionComponent_LinkCommentMedia_Call {
	return &MockDiscussionComponent_LinkCommentMedia_Call{Call: _e.mock.On("LinkCommentMedia", ctx, commentID, items)}
}

func (_c *MockDiscussionComponent_LinkCommentMedia_Call) Run(run func(ctx context.Context, commentID int64, items []types.CommentMediaItem)) *MockDiscussionComponent_LinkCommentMedia_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDiscussionComponent_LinkCommentMedia_Call) Return(_a0 error) *MockDiscussionComponent_LinkCommentMedia_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockDiscussionComponent_LinkCommentMedia_Call) RunAndReturn(run func(context.Context, int64, []types.CommentMediaItem) error) *MockDiscussionComponent_LinkCommentMedia_Call {
	_c.Call.Return(run)
	return _c
}
