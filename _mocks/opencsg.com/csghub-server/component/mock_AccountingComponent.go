...
func (_m *MockAccountingComponent) BatchCreatePrice(currentUser string, req types.AcctPriceBatchCreateReq) (interface{}, error) {
	...
	var r0 interface{}
	var r1 error
	if rf, ok := ret.Get(0).(func(string, types.AcctPriceBatchCreateReq) (interface{}, error)); ok {
		return rf(currentUser, req)
	}
	if rf, ok := ret.Get(0).(func(string, types.AcctPriceBatchCreateReq) interface{}); ok {
...
// MockAccountingComponent_BatchCreatePrice_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BatchCreatePrice'
type MockAccountingComponent_BatchCreatePrice_Call struct {
	*mock.Call
}
...
func (_e *MockAccountingComponent_Expecter) BatchCreatePrice(currentUser interface{}, req interface{}) *MockAccountingComponent_BatchCreatePrice_Call {
	return &MockAccountingComponent_BatchCreatePrice_Call{Call: _e.mock.On("BatchCreatePrice", currentUser, req)}
}

func (_c *MockAccountingComponent_BatchCreatePrice_Call) Run(run func(currentUser string, req types.AcctPriceBatchCreateReq)) *MockAccountingComponent_BatchCreatePrice_Call {
...
func (_c *MockAccountingComponent_BatchCreatePrice_Call) Return(_a0 interface{}, _a1 error) *MockAccountingComponent_BatchCreatePrice_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAccountingComponent_BatchCreatePrice_Call) RunAndReturn(run func(string, types.AcctPriceBatchCreateReq) (interface{}, error)) *MockAccountingComponent_BatchCreatePrice_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAccountingComponent) QueryDistinctPrices(currentUser string, req types.AcctPriceDistinctListReq) (any, error) {
	ret := _m.Called(currentUser, req)
...
// MockAccountingComponent_QueryDistinctPrices_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'QueryDistinctPrices'
type MockAccountingComponent_QueryDistinctPrices_Call struct {
	*mock.Call
}
...
func (_e *MockAccountingComponent_Expecter) QueryDistinctPrices(currentUser interface{}, req interface{}) *MockAccountingComponent_QueryDistinctPrices_Call {
	return &MockAccountingComponent_QueryDistinctPrices_Call{Call: _e.mock.On("QueryDistinctPrices", currentUser, req)}
}

func (_c *MockAccountingComponent_QueryDistinctPrices_Call) Run(run func(currentUser string, req types.AcctPriceDistinctListReq)) *MockAccountingComponent_QueryDistinctPrices_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAccountingComponent_QueryDistinctPrices_Call) Return(_a0 any, _a1 error) *MockAccountingComponent_QueryDistinctPrices_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAccountingComponent_QueryDistinctPrices_Call) RunAndReturn(run func(string, types.AcctPriceDistinctListReq) (any, error)) *MockAccountingComponent_QueryDistinctPrices_Call {
	_c.Call.Return(run)
	return _c
}
