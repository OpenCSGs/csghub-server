...
func (_m *MockSpaceComponent) Index(ctx context.Context, filter *types.RepoFilter, per int, page int) ([]types.Space, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.RepoFilter, int, int) ([]types.Space, int, error)); ok {
		return rf(ctx, filter, per, page)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.RepoFilter, int, int) []types.Space); ok {
...
//   - per int
//   - page int
func (_e *MockSpaceComponent_Expecter) Index(ctx interface{}, filter interface{}, per interface{}, page interface{}) *MockSpaceComponent_Index_Call {
	return &MockSpaceComponent_Index_Call{Call: _e.mock.On("Index", ctx, filter, per, page)}
}

func (_c *MockSpaceComponent_Index_Call) Run(run func(ctx context.Context, filter *types.RepoFilter, per int, page int)) *MockSpaceComponent_Index_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSpaceComponent_Index_Call) RunAndReturn(run func(context.Context, *types.RepoFilter, int, int) ([]types.Space, int, error)) *MockSpaceComponent_Index_Call {
	_c.Call.Return(run)
	return _c
}
