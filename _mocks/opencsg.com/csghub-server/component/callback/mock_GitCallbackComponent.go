...
// SyncRepositoryPackage provides a mock function with given fields: ctx, req
func (_m *MockGitCallbackComponent) SyncRepositoryPackage(ctx context.Context, req *types.GiteaCallbackPushReq) error {
	ret := _m.Called(ctx, req)
...
// MockGitCallbackComponent_SyncRepositoryPackage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncRepositoryPackage'
type MockGitCallbackComponent_SyncRepositoryPackage_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - req *types.GiteaCallbackPushReq
func (_e *MockGitCallbackComponent_Expecter) SyncRepositoryPackage(ctx interface{}, req interface{}) *MockGitCallbackComponent_SyncRepositoryPackage_Call {
	return &MockGitCallbackComponent_SyncRepositoryPackage_Call{Call: _e.mock.On("SyncRepositoryPackage", ctx, req)}
}

func (_c *MockGitCallbackComponent_SyncRepositoryPackage_Call) Run(run func(ctx context.Context, req *types.GiteaCallbackPushReq)) *MockGitCallbackComponent_SyncRepositoryPackage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*types.GiteaCallbackPushReq))
	})
	return _c
...
func (_c *MockGitCallbackComponent_SyncRepositoryPackage_Call) Return(_a0 error) *MockGitCallbackComponent_SyncRepositoryPackage_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockGitCallbackComponent_SyncRepositoryPackage_Call) RunAndReturn(run func(context.Context, *types.GiteaCallbackPushReq) error) *MockGitCallbackComponent_SyncRepositoryPackage_Call {
	_c.Call.Return(run)
	return _c
}
