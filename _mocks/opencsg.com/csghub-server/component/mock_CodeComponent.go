...
func (_m *MockCodeComponent) GetUploadUrl(ctx context.Context) (string, string, map[string]string, error) {
	ret := _m.Called(ctx)
...
// MockCodeComponent_GetUploadUrl_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUploadUrl'
type MockCodeComponent_GetUploadUrl_Call struct {
	*mock.Call
}

// GetUploadUrl is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockCodeComponent_Expecter) GetUploadUrl(ctx interface{}) *MockCodeComponent_GetUploadUrl_Call {
	return &MockCodeComponent_GetUploadUrl_Call{Call: _e.mock.On("GetUploadUrl", ctx)}
}

func (_c *MockCodeComponent_GetUploadUrl_Call) Run(run func(ctx context.Context)) *MockCodeComponent_GetUploadUrl_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCodeComponent_GetUploadUrl_Call) Return(_a0 string, _a1 string, _a2 map[string]string, _a3 error) *MockCodeComponent_GetUploadUrl_Call {
	_c.Call.Return(_a0, _a1, _a2, _a3)
	return _c
}

func (_c *MockCodeComponent_GetUploadUrl_Call) RunAndReturn(run func(context.Context) (string, string, map[string]string, error)) *MockCodeComponent_GetUploadUrl_Call {
	_c.Call.Return(run)
	return _c
}
