...
// CheckCurrentUserPermission provides a mock function with given fields: ctx, userName, namespace, permission
func (_m *MockRepoComponent) CheckCurrentUserPermission(ctx context.Context, userName string, namespace string, permission rebac.Permission) (bool, error) {
	ret := _m.Called(ctx, userName, namespace, permission)
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, rebac.Permission) (bool, error)); ok {
		return rf(ctx, userName, namespace, permission)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, rebac.Permission) bool); ok {
		r0 = rf(ctx, userName, namespace, permission)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, rebac.Permission) error); ok {
		r1 = rf(ctx, userName, namespace, permission)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockRepoComponent_Expecter) CheckCurrentUserPermission(ctx interface{}, userName interface{}, namespace interface{}, permission interface{}) *MockRepoComponent_CheckCurrentUserPermission_Call {
	return &MockRepoComponent_CheckCurrentUserPermission_Call{Call: _e.mock.On("CheckCurrentUserPermission", ctx, userName, namespace, permission)}
}

func (_c *MockRepoComponent_CheckCurrentUserPermission_Call) Run(run func(ctx context.Context, userName string, namespace string, permission rebac.Permission)) *MockRepoComponent_CheckCurrentUserPermission_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(rebac.Permission))
	})
	return _c
}
...
func (_c *MockRepoComponent_CheckCurrentUserPermission_Call) RunAndReturn(run func(context.Context, string, string, rebac.Permission) (bool, error)) *MockRepoComponent_CheckCurrentUserPermission_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRepoComponent) CreateFork(ctx context.Context, req types.CreateForkReq) (*database.Repository, error) {
	ret := _m.Called(ctx, req)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.CreateForkReq) (*database.Repository, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.CreateForkReq) *database.Repository); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
...
// MockRepoComponent_CreateFork_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateFork'
type MockRepoComponent_CreateFork_Call struct {
	*mock.Call
}
...
func (_e *MockRepoComponent_Expecter) CreateFork(ctx interface{}, req interface{}) *MockRepoComponent_CreateFork_Call {
	return &MockRepoComponent_CreateFork_Call{Call: _e.mock.On("CreateFork", ctx, req)}
}

func (_c *MockRepoComponent_CreateFork_Call) Run(run func(ctx context.Context, req types.CreateForkReq)) *MockRepoComponent_CreateFork_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRepoComponent_CreateFork_Call) Return(_a0 *database.Repository, _a1 error) *MockRepoComponent_CreateFork_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepoComponent_CreateFork_Call) RunAndReturn(run func(context.Context, types.CreateForkReq) (*database.Repository, error)) *MockRepoComponent_CreateFork_Call {
	_c.Call.Return(run)
	return _c
}
...
// DownloadRepoZip provides a mock function with given fields: ctx, req, currentUser
func (_m *MockRepoComponent) DownloadRepoZip(ctx context.Context, req types.DownloadRepoZipReq, currentUser string) ([]byte, error) {
	ret := _m.Called(ctx, req, currentUser)

	if len(ret) == 0 {
		panic("no return value specified for DownloadRepoZip")
	}

	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.DownloadRepoZipReq, string) ([]byte, error)); ok {
		return rf(ctx, req, currentUser)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.DownloadRepoZipReq, string) []byte); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, types.DownloadRepoZipReq, string) error); ok {
...
// MockRepoComponent_DownloadRepoZip_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DownloadRepoZip'
type MockRepoComponent_DownloadRepoZip_Call struct {
	*mock.Call
}

// DownloadRepoZip is a helper method to define mock.On call
//   - ctx context.Context
//   - req types.DownloadRepoZipReq
//   - currentUser string
func (_e *MockRepoComponent_Expecter) DownloadRepoZip(ctx interface{}, req interface{}, currentUser interface{}) *MockRepoComponent_DownloadRepoZip_Call {
	return &MockRepoComponent_DownloadRepoZip_Call{Call: _e.mock.On("DownloadRepoZip", ctx, req, currentUser)}
}

func (_c *MockRepoComponent_DownloadRepoZip_Call) Run(run func(ctx context.Context, req types.DownloadRepoZipReq, currentUser string)) *MockRepoComponent_DownloadRepoZip_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.DownloadRepoZipReq), args[2].(string))
	})
	return _c
}

func (_c *MockRepoComponent_DownloadRepoZip_Call) Return(_a0 []byte, _a1 error) *MockRepoComponent_DownloadRepoZip_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepoComponent_DownloadRepoZip_Call) RunAndReturn(run func(context.Context, types.DownloadRepoZipReq, string) ([]byte, error)) *MockRepoComponent_DownloadRepoZip_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRepoComponent) GetRepoSizeByBranch(ctx context.Context, repoType types.RepositoryType, namespace string, name string, branch string, currentUser string) (types.RepoSizeResponse, error) {
	...
	if rf, ok := ret.Get(1).(func(context.Context, types.RepositoryType, string, string, string, string) error); ok {
		r1 = rf(ctx, repoType, namespace, name, branch, currentUser)
	} else {
		r1 = ret.Error(1)
	}
...
// MockRepoComponent_GetRepoSizeByBranch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetRepoSizeByBranch'
type MockRepoComponent_GetRepoSizeByBranch_Call struct {
	*mock.Call
}

// GetRepoSizeByBranch is a helper method to define mock.On call
//   - ctx context.Context
//   - repoType types.RepositoryType
//   - namespace string
//   - name string
//   - branch string
//   - currentUser string
func (_e *MockRepoComponent_Expecter) GetRepoSizeByBranch(ctx interface{}, repoType interface{}, namespace interface{}, name interface{}, branch interface{}, currentUser interface{}) *MockRepoComponent_GetRepoSizeByBranch_Call {
	return &MockRepoComponent_GetRepoSizeByBranch_Call{Call: _e.mock.On("GetRepoSizeByBranch", ctx, repoType, namespace, name, branch, currentUser)}
}

func (_c *MockRepoComponent_GetRepoSizeByBranch_Call) Run(run func(ctx context.Context, repoType types.RepositoryType, namespace string, name string, branch string, currentUser string)) *MockRepoComponent_GetRepoSizeByBranch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// SyncRepositoryPackage provides a mock function with given fields: ctx, repo, namespace, name, branch
func (_m *MockRepoComponent) SyncRepositoryPackage(ctx context.Context, repo *database.Repository, namespace string, name string, branch string) error {
	ret := _m.Called(ctx, repo, namespace, name, branch)

	if len(ret) == 0 {
		panic("no return value specified for SyncRepositoryPackage")
	}
...
// MockRepoComponent_SyncRepositoryPackage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SyncRepositoryPackage'
type MockRepoComponent_SyncRepositoryPackage_Call struct {
	*mock.Call
}

// SyncRepositoryPackage is a helper method to define mock.On call
//   - ctx context.Context
//   - repo *database.Repository
//   - namespace string
//   - name string
//   - branch string
func (_e *MockRepoComponent_Expecter) SyncRepositoryPackage(ctx interface{}, repo interface{}, namespace interface{}, name interface{}, branch interface{}) *MockRepoComponent_SyncRepositoryPackage_Call {
	return &MockRepoComponent_SyncRepositoryPackage_Call{Call: _e.mock.On("SyncRepositoryPackage", ctx, repo, namespace, name, branch)}
}

func (_c *MockRepoComponent_SyncRepositoryPackage_Call) Run(run func(ctx context.Context, repo *database.Repository, namespace string, name string, branch string)) *MockRepoComponent_SyncRepositoryPackage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRepoComponent_SyncRepositoryPackage_Call) Return(_a0 error) *MockRepoComponent_SyncRepositoryPackage_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRepoComponent_SyncRepositoryPackage_Call) RunAndReturn(run func(context.Context, *database.Repository, string, string, string) error) *MockRepoComponent_SyncRepositoryPackage_Call {
	_c.Call.Return(run)
	return _c
}
