...
// ListExternalLLMs provides a mock function with given fields: ctx
func (_m *MockLLMServiceComponent) ListExternalLLMs(ctx context.Context) ([]*types.LLMConfig, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for ListExternalLLMs")
	}

	var r0 []*types.LLMConfig
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]*types.LLMConfig, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []*types.LLMConfig); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*types.LLMConfig)
...
// MockLLMServiceComponent_ListExternalLLMs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListExternalLLMs'
type MockLLMServiceComponent_ListExternalLLMs_Call struct {
	*mock.Call
}

// ListExternalLLMs is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockLLMServiceComponent_Expecter) ListExternalLLMs(ctx interface{}) *MockLLMServiceComponent_ListExternalLLMs_Call {
	return &MockLLMServiceComponent_ListExternalLLMs_Call{Call: _e.mock.On("ListExternalLLMs", ctx)}
}

func (_c *MockLLMServiceComponent_ListExternalLLMs_Call) Run(run func(ctx context.Context)) *MockLLMServiceComponent_ListExternalLLMs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockLLMServiceComponent_ListExternalLLMs_Call) Return(_a0 []*types.LLMConfig, _a1 error) *MockLLMServiceComponent_ListExternalLLMs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockLLMServiceComponent_ListExternalLLMs_Call) RunAndReturn(run func(context.Context) ([]*types.LLMConfig, error)) *MockLLMServiceComponent_ListExternalLLMs_Call {
	_c.Call.Return(run)
	return _c
}
