...
func (_m *MockAccountingBillComponent) ListBillsDetailByUserID(ctx context.Context, req types.AcctBillsDetailReq) (database.AccountBillDetailRes, error) {
	ret := _m.Called(ctx, req)
...
// MockAccountingBillComponent_ListBillsDetailByUserID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListBillsDetailByUserID'
type MockAccountingBillComponent_ListBillsDetailByUserID_Call struct {
	*mock.Call
}
...
func (_e *MockAccountingBillComponent_Expecter) ListBillsDetailByUserID(ctx interface{}, req interface{}) *MockAccountingBillComponent_ListBillsDetailByUserID_Call {
	return &MockAccountingBillComponent_ListBillsDetailByUserID_Call{Call: _e.mock.On("ListBillsDetailByUserID", ctx, req)}
}

func (_c *MockAccountingBillComponent_ListBillsDetailByUserID_Call) Run(run func(ctx context.Context, req types.AcctBillsDetailReq)) *MockAccountingBillComponent_ListBillsDetailByUserID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAccountingBillComponent_ListBillsDetailByUserID_Call) Return(_a0 database.AccountBillDetailRes, _a1 error) *MockAccountingBillComponent_ListBillsDetailByUserID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAccountingBillComponent_ListBillsDetailByUserID_Call) RunAndReturn(run func(context.Context, types.AcctBillsDetailReq) (database.AccountBillDetailRes, error)) *MockAccountingBillComponent_ListBillsDetailByUserID_Call {
	_c.Call.Return(run)
	return _c
}
