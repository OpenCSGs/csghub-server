...
// AddNewStatement provides a mock function with given fields: ctx, event, checkBalance
func (_m *MockAccountingStatementComponent) AddNewStatement(ctx context.Context, event *types.AcctEventReq, checkBalance ...bool) error {
	ret := _m.Called(ctx, event, checkBalance)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.AcctEventReq, ...bool) error); ok {
		r0 = rf(ctx, event, checkBalance...)
	} else {
		r0 = ret.Error(0)
	}
...
//   - checkBalance ...bool
func (_e *MockAccountingStatementComponent_Expecter) AddNewStatement(ctx interface{}, event interface{}, checkBalance ...interface{}) *MockAccountingStatementComponent_AddNewStatement_Call {
	args := append([]interface{}{ctx, event}, checkBalance...)
	return &MockAccountingStatementComponent_AddNewStatement_Call{Call: _e.mock.On("AddNewStatement", args...)}
}

func (_c *MockAccountingStatementComponent_AddNewStatement_Call) Run(run func(ctx context.Context, event *types.AcctEventReq, checkBalance ...bool)) *MockAccountingStatementComponent_AddNewStatement_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var checkBalance []bool
		if len(args) > 2 {
			if cb, ok := args[2].([]bool); ok {
				checkBalance = cb
			}
		}
		run(args[0].(context.Context), args[1].(*types.AcctEventReq), checkBalance...)
	})
	return _c
}
...
func (_c *MockAccountingStatementComponent_AddNewStatement_Call) RunAndReturn(run func(context.Context, *types.AcctEventReq, ...bool) error) *MockAccountingStatementComponent_AddNewStatement_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockAccountingStatementComponent) HasUserPurchasedDataset(ctx context.Context, userUUID string, datasetID int64) (bool, error) {
...
// MockAccountingStatementComponent_HasUserPurchasedDataset_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasUserPurchasedDataset'
type MockAccountingStatementComponent_HasUserPurchasedDataset_Call struct {
	*mock.Call
}
...
//   - userUUID string
//   - datasetID int64
func (_e *MockAccountingStatementComponent_Expecter) HasUserPurchasedDataset(ctx interface{}, userUUID interface{}, datasetID interface{}) *MockAccountingStatementComponent_HasUserPurchasedDataset_Call {
	return &MockAccountingStatementComponent_HasUserPurchasedDataset_Call{Call: _e.mock.On("HasUserPurchasedDataset", ctx, userUUID, datasetID)}
}

func (_c *MockAccountingStatementComponent_HasUserPurchasedDataset_Call) Run(run func(ctx context.Context, userUUID string, datasetID int64)) *MockAccountingStatementComponent_HasUserPurchasedDataset_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAccountingStatementComponent_HasUserPurchasedDataset_Call) Return(_a0 bool, _a1 error) *MockAccountingStatementComponent_HasUserPurchasedDataset_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAccountingStatementComponent_HasUserPurchasedDataset_Call) RunAndReturn(run func(context.Context, string, int64) (bool, error)) *MockAccountingStatementComponent_HasUserPurchasedDataset_Call {
	_c.Call.Return(run)
	return _c
}
