...
type SensitiveComponent interface {
	PassTextCheck(ctx context.Context, scenario types.SensitiveScenario, text string) (*ss_type.CheckResult, error)
	PassImageCheck(ctx context.Context, scenario types.SensitiveScenario, ossBucketName, ossObjectName string) (*ss_type.CheckResult, error)
	PassImageURLCheck(ctx context.Context, scenario types.SensitiveScenario, imageURL string) (*ss_type.CheckResult, error)
	// PassStreamCheck check stream chunk text
	PassStreamCheck(ctx context.Context, req *types.LLMCheckRequest) (*ss_type.CheckResult, error)
	// PassLLMQueryCheck check LLM prompt text
	PassLLMQueryCheck(ctx context.Context, req *types.LLMCheckRequest) (*ss_type.CheckResult, error)
...
func (c SensitiveComponentImpl) PassTextCheck(ctx context.Context, scenario types.SensitiveScenario, text string) (*ss_type.CheckResult, error) {
	return c.checker.PassTextCheck(ctx, scenario, text)
}

func (c SensitiveComponentImpl) PassImageCheck(ctx context.Context, scenario types.SensitiveScenario, ossBucketName, ossObjectName string) (*ss_type.CheckResult, error) {
	return c.checker.PassImageCheck(ctx, scenario, ossBucketName, ossObjectName)
}

func (c SensitiveComponentImpl) PassStreamCheck(ctx context.Context, req *types.LLMCheckRequest) (*ss_type.CheckResult, error) {
	req.Stream = true
...
func (c SensitiveComponentImpl) PassLLMQueryCheck(ctx context.Context, req *types.LLMCheckRequest) (*ss_type.CheckResult, error) {
	req.IsAppendSystemPromot = false
	if req.Stream {
...
func (c SensitiveComponentImpl) PassImageURLCheck(ctx context.Context, scenario types.SensitiveScenario, imageURL string) (*ss_type.CheckResult, error) {
...
func (c SensitiveComponentImpl) SubmitMediaModeration(ctx context.Context, req types.MediaModerationRequest) (*types.MediaModerationSubmission, error) {
	mc, ok := c.checker.(ss_type.MediaSensitiveChecker)
	if !ok {
