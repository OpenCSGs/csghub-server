...
type AgentComponent interface {
	...
	GetKnowledgeBaseByContentID(ctx context.Context, contentID string, userUUID string) (*types.AgentKnowledgeBaseDetail, error)
	...
	IsKnowledgeBaseExistsByContentID(ctx context.Context, contentID string) (bool, error)
}
