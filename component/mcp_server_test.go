...
func TestMCPServerComponent_CheckDeployBranch(t *testing.T) {
	...
	mc.mocks.components.repo.EXPECT().CheckAccountAndResource(ctx, types.CheckResourceAndAccountReq{UserName: "user", ClusterID: "cls", OrderDetailID: 0, CurrentUser: "user"}, &database.SpaceResource{
		ID: 1,
