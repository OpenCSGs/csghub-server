...
func createAgentRoutes(
	...
	instancesGroup := agentGroup.Group("/instances")
	{
		...
		// Task routes
		tasksGroup := agentGroup.Group("/tasks")
		{
			tasksGroup.GET("", middlewareCollection.Auth.NeedLogin, agentHandler.ListTasks)
			tasksGroup.GET("/:id", middlewareCollection.Auth.NeedLogin, agentHandler.GetTaskDetail)
		}
	}
