...
func createModelRoutes(config *config.Config,
	...
	// Models repo operation routes
	{
		...
		modelsGroup.POST("/:namespace/:name/update_downloads", middlewareCollection.Auth.NeedAdmin, repoCommonHandler.UpdateDownloads)
		modelsGroup.PUT("/:namespace/:name/incr_downloads", middlewareCollection.Auth.NeedAdmin, repoCommonHandler.IncrDownloads)
...
func createDatasetRoutes(
	...
	datasetsGroup.Use(middleware.RepoType(types.DatasetRepo), middlewareCollection.Repo.RepoExists)
	{
		...
		datasetsGroup.POST("/:namespace/:name/update_downloads", middleware.NeedAdmin(config), repoCommonHandler.UpdateDownloads)
		datasetsGroup.PUT("/:namespace/:name/incr_downloads", middleware.NeedAdmin(config), repoCommonHandler.IncrDownloads)
...
func createCodeRoutes(
	...
	codesGroup.Use(middleware.RepoType(types.CodeRepo), middlewareCollection.Repo.RepoExists)
	{
		...
		codesGroup.PUT("/:namespace/:name/incr_downloads", middlewareCollection.Auth.NeedAdmin, repoCommonHandler.IncrDownloads)
...
func createSpaceRoutes(config *config.Config,
	...
	}
	{
		...
		spaces.POST("/:namespace/:name/update_downloads", middlewareCollection.Auth.NeedAdmin, repoCommonHandler.UpdateDownloads)
		spaces.PUT("/:namespace/:name/incr_downloads", middlewareCollection.Auth.NeedAdmin, repoCommonHandler.IncrDownloads)
...
func createPromptRoutes(
	...
	promptGrp.Use(middleware.RepoType(types.PromptRepo), middlewareCollection.Repo.RepoExists)
	{
		...
		promptGrp.POST("/:namespace/:name/prompt/versions/*file_path", middlewareCollection.Auth.NeedLogin, promptHandler.CreatePromptVersion)
		promptGrp.GET("/:namespace/:name/prompt/versions/*file_path", promptHandler.ListPromptVersions)
		promptGrp.GET("/:namespace/:name/prompt/version/:version/*file_path", promptHandler.GetPromptVersion)
		promptGrp.PUT("/:namespace/:name/prompt/version/:version/*file_path", middlewareCollection.Auth.NeedLogin, promptHandler.UpdatePromptVersion)
		...
		promptGrp.POST("/:namespace/:name/update_downloads", middlewareCollection.Auth.NeedAdmin, promptHandler.UpdateDownloads)
	}
	{
...
func createOrgRoutes(apiGroup *gin.RouterGroup, middlewareCollection middleware.MiddlewareCollection, userProxyHandler *handler.InternalServiceProxyHandler, orgHandler *handler.OrganizationHandler) {
	{
		...
		apiGroup.GET("/organization/:namespace/finetune/instances", middlewareCollection.Auth.NeedLogin, orgHandler.FinetuneInstances)
		apiGroup.GET("/organization/:namespace/finetune/jobs", middlewareCollection.Auth.NeedLogin, orgHandler.FinetuneJobs)
		apiGroup.GET("/organization/:namespace/evaluations", middlewareCollection.Auth.NeedLogin, orgHandler.Evaluations)
		apiGroup.GET("/organization/:namespace/run/:repo_type", middlewareCollection.Auth.NeedLogin, orgHandler.RunDeploys)
		apiGroup.GET("/organization/:namespace/notebooks", middlewareCollection.Auth.NeedLogin, orgHandler.Notebooks)
...
func createSkillRoutes(
	...
	skillGroup.Use(middleware.RepoType(types.SkillRepo), middlewareCollection.Repo.RepoExists)
	{
		...
		skillGroup.POST("/:namespace/:name/update_downloads", middlewareCollection.Auth.NeedAdmin, repoCommonHandler.UpdateDownloads)
		skillGroup.PUT("/:namespace/:name/incr_downloads", middlewareCollection.Auth.NeedAdmin, repoCommonHandler.IncrDownloads)
