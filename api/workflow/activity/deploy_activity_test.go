...
func TestActivities_handleDeployError(t *testing.T) {
	...
	// Setup expectations
	tester.mockDeployTaskStore.EXPECT().GetLastTaskByType(mock.Anything, task.Deploy.ID, task.TaskType).Return(task, nil)
...
func TestBuildFailed(t *testing.T) {
	...
	tester.mockDeployTaskStore.EXPECT().GetLastTaskByType(mock.Anything, buildTask.Deploy.ID, buildTask.TaskType).Return(buildTask, nil)
...
func TestDeploy(t *testing.T) {
	...
	tester.mockDeployTaskStore.EXPECT().UpdateDeployTask(mock.Anything, mock.Anything).Return(nil).Maybe()
	tester.mockDeployTaskStore.EXPECT().GetLastTaskByType(mock.Anything, runTask.Deploy.ID, runTask.TaskType).Return(runTask, nil)
	tester.mockDeployTaskStore.EXPECT().UpdateInTx(mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Return(nil)
