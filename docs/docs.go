...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/codes/{namespace}/{name}/blob/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/codes/{namespace}/{name}/download/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/codes/{namespace}/{name}/last_commit": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/codes/{namespace}/{name}/raw/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/codes/{namespace}/{name}/resolve/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/codes/{namespace}/{name}/update_downloads": {
            "post": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/codes/{namespace}/{name}/upload_file": {
            "post": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/blob/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/branches": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/download/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/last_commit": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/raw/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/resolve/{file_path}": {
            "get": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/update_downloads": {
            "post": {
                "security": [
                    {
                        "ApiKey": []
        ...
        "/spaces/{namespace}/{name}/upload_file": {
            "post": {
                "security": [
                    {
                        "ApiKey": []
