...
type GitServer interface {
	...
	GetModelFileReader(namespace, repoName, ref, filePath string, lfs bool) (io.ReadCloser, error)
	...
	GetDatasetFileReader(namespace, repoName, ref, filePath string, lfs bool) (io.ReadCloser, error)
