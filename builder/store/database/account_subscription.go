...
func (a *accountSubscriptionStoreImpl) beginNewSubscription(ctx context.Context, tx bun.Tx,
	...
	err = a.generateAcctStatement(ctx, tx, req.EventUUID, acctUser.UserUUID, postPrice, now, amountValue, req.OpUserUUID)
	if err != nil {
		return err
	}
...
func (a *accountSubscriptionStoreImpl) generateAcctStatement(ctx context.Context, tx bun.Tx,
	...
	_, err := DeductAccountFee(ctx, tx, statement, false)
	if err != nil {
