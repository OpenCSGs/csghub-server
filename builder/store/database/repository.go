...
type Repository struct {
	...
	// OrgInheritBlocked disables inherited permissions from the repository organization.
	OrgInheritBlocked          bool               `bun:",notnull,default:false" json:"org_inherit_blocked"`
