...
func (c *fakeOpenAIComponent) SetCapacityAdmissionAvailabilitySource(src aigwtypes.UpstreamCircuitStateSource) {
}

func (c *fakeOpenAIComponent) ShutdownCapacityAdmission() {
}
