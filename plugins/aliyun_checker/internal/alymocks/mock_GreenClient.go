...
import (
	...
	aliyun "opencsg.com/csghub-server/plugins/aliyun_checker/internal/aliyun"
...
func (_m *MockGreenClient) TextScan(request *green.TextScanRequest) (*aliyun.TextScanResponse, error) {
	...
	var r0 *aliyun.TextScanResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(*green.TextScanRequest) (*aliyun.TextScanResponse, error)); ok {
		return rf(request)
	}
	if rf, ok := ret.Get(0).(func(*green.TextScanRequest) *aliyun.TextScanResponse); ok {
		r0 = rf(request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*aliyun.TextScanResponse)
		}
	}
...
func (_c *MockGreenClient_TextScan_Call) Return(response *aliyun.TextScanResponse, err error) *MockGreenClient_TextScan_Call {
	_c.Call.Return(response, err)
	return _c
}

func (_c *MockGreenClient_TextScan_Call) RunAndReturn(run func(*green.TextScanRequest) (*aliyun.TextScanResponse, error)) *MockGreenClient_TextScan_Call {
	_c.Call.Return(run)
	return _c
}
